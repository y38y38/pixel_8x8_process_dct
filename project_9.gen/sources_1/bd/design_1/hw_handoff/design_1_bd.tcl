...
proc create_root_design { parentCell } {
  ...
  # Create instance: signal_controller_wr_0, and set properties
  set block_name signal_controller_wrapper
  set block_cell_name signal_controller_wr_0
  if { [catch {set signal_controller_wr_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $signal_controller_wr_0 eq "" } {
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins signal_controller_wr_0/DOUTB]
  connect_bd_net -net myip_0_INPUT_ADDRESS [get_bd_pins myip_0/INPUT_ADDRESS] [get_bd_pins signal_controller_wr_0/INPUT_RAM_ADDRESS]
  connect_bd_net -net myip_0_OUTPUT_ADDRESS [get_bd_pins myip_0/OUTPUT_ADDRESS] [get_bd_pins signal_controller_wr_0/OUTPUT_RAM_ADDRESS]
  connect_bd_net -net myip_0_START [get_bd_pins myip_0/START] [get_bd_pins signal_controller_wr_0/START]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins myip_0/s00_axi_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins signal_controller_wr_0/RESET]
  connect_bd_net -net signal_controller_wr_0_ADDRB [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins signal_controller_wr_0/ADDRB]
  connect_bd_net -net signal_controller_wr_0_CLKB [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins signal_controller_wr_0/CLKB]
  connect_bd_net -net signal_controller_wr_0_DINB [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins signal_controller_wr_0/DINB]
  connect_bd_net -net signal_controller_wr_0_ENB [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins signal_controller_wr_0/ENB]
  connect_bd_net -net signal_controller_wr_0_RSTB [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins signal_controller_wr_0/RSTB]
  connect_bd_net -net signal_controller_wr_0_STATUS1 [get_bd_pins myip_0/STATUS1] [get_bd_pins signal_controller_wr_0/STATUS1]
  connect_bd_net -net signal_controller_wr_0_STATUS2 [get_bd_pins myip_0/STATUS2] [get_bd_pins signal_controller_wr_0/STATUS2]
  connect_bd_net -net signal_controller_wr_0_WEB [get_bd_pins blk_mem_gen_0/web] [get_bd_pins signal_controller_wr_0/WEB]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins myip_0/s00_axi_aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins signal_controller_wr_0/CLOCK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
