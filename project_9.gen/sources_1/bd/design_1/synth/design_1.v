...
module design_1
  ...
  wire [31:0]signal_controller_wr_0_ADDRB;
  wire signal_controller_wr_0_CLKB;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(signal_controller_wr_0_ADDRB),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(signal_controller_wr_0_CLKB),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(signal_controller_wr_0_DINB),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(signal_controller_wr_0_ENB),
  ...
  design_1_signal_controller_wr_0_0 signal_controller_wr_0
       (.ADDRB(signal_controller_wr_0_ADDRB),
        .CLKB(signal_controller_wr_0_CLKB),
